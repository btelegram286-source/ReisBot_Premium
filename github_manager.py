...
class GitHubManager:
    ...
    def update_file(self, repo_name, file_path, new_content, commit_message=None):
        ...
        try:
            ...
            # Repository boşsa veya dosya yoksa create_file kullan
            if "404" in str(e) and "empty" in str(e).lower():
                return self.create_file(repo_name, file_path, new_content, commit_message)
    ...
    def get_file_content(self, repo_name, file_path):
        ...
        try:
            ...
            # Repository boşsa veya dosya yoksa None döndür
            if "404" in str(e) and "empty" in str(e).lower():
                return None
    ...
    def delete_repository(self, repo_name):
        ...
        try:
            repo = self.user.get_repo(repo_name)
            repo.delete()
            return f"✅ Repository silindi: {repo_name}"
        except Exception as e:
            logger.error(f"Repository silme hatası: {e}")
            return f"❌ Repository silme hatası: {str(e)}"
    ...
    def get_all_repositories(self):
        ...
        try:
            ...
            logger.error(f"Repository listeleme hatası: {e}")
            return []
